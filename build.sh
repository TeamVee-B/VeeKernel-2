...
case "$choice" in
	1 ) target="L3"; serie="II-"; variant="Single"; echo "$choice - $target$serie$variant"; make cyanogenmod_vee3_defconfig &> /dev/null; maindevicecheck="On";;
	2 ) target="L3"; serie="II-"; variant="Dual"; echo "$choice - $target$serie$variant"; make cyanogenmod_vee3ds_defconfig &> /dev/null; maindevicecheck="On";;
